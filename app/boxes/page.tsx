        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {boxes.map((box) => (
            <Link
              key={box.id}
              href={`/boxes/${box.id}`}
              className="bg-white rounded-xl border border-slate-200 p-4 hover:border-indigo-200 hover:shadow-sm transition-all group"
            >
              ...
              <div className="font-semibold text-slate-800 group-hover:text-indigo-700 transition-colors">{box.name}</div>
